...
<head>
    ...
    <style>
        ...
        input[type="password"] { width:100%; padding:8px 10px; border-radius:8px; border:1px solid var(--tr-border); background:#fff; color: var(--tr-text); font-size:13px; }
...
<div class="wrapper">
    <div class="card">
        ...
        <div class="hint" style="margin-top:12px; font-size:11px; color: var(--tr-muted-text);">
