...
<h1 style="margin:0 0 4px; font-size:18px;"><?= esc($title ?? 'How to Use'); ?></h1>
<?php if (! empty($subtitle)): ?>
    <div style="margin:0 0 12px; font-size:12px; color:#555;"><?= esc($subtitle); ?></div>
<?php endif; ?>
...
<h2 style="margin:0 0 6px; font-size:14px;">Quick Start (Harian)</h2>
...
<h2 style="margin:0 0 6px; font-size:14px;">Panduan Menu</h2>
...
<h2 style="margin:0 0 6px; font-size:14px;">Catatan</h2>
