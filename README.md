...
This repository includes an automated `.env` format check to prevent DotEnv parsing errors.

-   See `docs/ENV_FORMAT_CHECK.md` for details and local usage instructions.
